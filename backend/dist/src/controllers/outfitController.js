...
exports.getUserPoints = exports.toggleEquipOutfit = exports.buyOutfit = exports.getUserOutfits = exports.getAllOutfits = void 0;
...
exports.getUserOutfits = getUserOutfits;
// Buy an outfit
const buyOutfit = async (req, res) => {
    try {
        const userId = req.userId;
...
exports.buyOutfit = buyOutfit;
// Equip/unequip an outfit
const toggleEquipOutfit = async (req, res) => {
    try {
        const userId = req.userId;
        const outfitId = parseInt(req.params.id);
...
exports.toggleEquipOutfit = toggleEquipOutfit;
// Get user points
